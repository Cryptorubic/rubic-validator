...
from backend.consts import (
    ...
    ETH_LIKE_ADDRESS_LENGTH_WITHOUT_0X_PREFIX,
    NETWORK_ERROR,
    NETWORK_NAMES,
)
...
def convert_to_ethereum_like_token_address(
    ...
    ) and len(token_address) != ETH_LIKE_ADDRESS_LENGTH:
        token_address = add_0x_prefix(
            token_address[-ETH_LIKE_ADDRESS_LENGTH_WITHOUT_0X_PREFIX:])
